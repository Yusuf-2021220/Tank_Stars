...
public class Choosing_Tank_Screen implements Screen{
    ...
    public Choosing_Tank_Screen(final Control ctrl)
    {
        this.ctrl = ctrl;
    ...
    public void render(float delta) {
        ...
        ctrl.batch.begin();
        ctrl.font.draw(ctrl.batch, "Choose Tank for Player 1", stage.getWidth() /2, stage.getHeight()-100);
        ctrl.batch.end();
